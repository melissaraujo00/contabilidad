                        ...
                        <tbody>
                            @foreach ($customers as $customer)
                                <tr class="border-t border-gray-200 dark:border-gray-700 
                                    ...
                                    {{-- Tipo --}}
                                    <td class="px-4 py-2 text-gray-700 dark:text-gray-200 capitalize">
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        ...
                                        {{-- ELIMINAR --}}
                                        <button 
                                            @click="openModal = true; deleteUrl = '{{ route('customers.destroy', $customer->id) }}';"
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button
                        ...
                        class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-700 
                               dark:text-gray-200 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition">
                        Cancelar
                    </button>
        ...
        <script>
            $(document).ready(function () {
                ...
                let table = $('#customersTable').DataTable({
                    ...
                    layout: {
                        topStart: { buttons: ['copy', 'excel', 'pdf', 'print'] }
                    },
                ...
                const applyDarkMode = () => {
                    ...
                    $('.dataTables_filter input')
                        .toggleClass('bg-gray-800 text-gray-100 border-gray-600', dark)
                        .toggleClass('bg-white text-gray-900', !dark);

                    $('.dt-button')
                        .toggleClass('bg-gray-700 text-gray-200 hover:bg-gray-600', dark)
                        .toggleClass('bg-white text-gray-800', !dark);
                };
