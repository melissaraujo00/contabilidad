        ...
        <div class="bg-white dark:bg-gray-900 shadow dark:shadow-gray-800 sm:rounded-lg p-6
            ...
            <form method="POST" action="{{ route('customers.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <x-input-error :messages="$errors->get('apellido')" class="mt-2 dark:text-red-400" />
                </div>
                ...
                <div>
                    ...
                    <x-text-input id="telefono" name="telefono" type="text"
                        class="mt-1 block w-full dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600"
                        value="{{ old('telefono') }}" />
                    <x-input-error :messages="$errors->get('telefono')" class="mt-2 dark:text-red-400" />
                </div>
                ...
                <div>
                    ...
                    <x-text-input id="nit" name="nit" type="text"
                        class="mt-1 block w-full dark:bg-gray-800 dark:text-gray-100 dark:border-gray-600"
                        value="{{ old('nit') }}" />
                    <x-input-error :messages="$errors->get('nit')" class="mt-2 dark:text-red-400" />
                </div>
                ...
                <div>
                    ...
                    <x-input-error :messages="$errors->get('direccion')" class="mt-2 dark:text-red-400" />
                </div>
                ...
                <div>
                    ...
                    <select id="tipo_cliente" name="tipo_cliente"
                        ...
                        @foreach ($tipos as $tipo)
                            <option value="{{ $tipo->value }}" 
                                {{ old('tipo_cliente') == $tipo->value ? 'selected' : '' }}>
                                {{ ucfirst($tipo->value) }}
                            </option>
                        @endforeach
                    ...
                    <x-input-error :messages="$errors->get('tipo_cliente')" class="mt-2 dark:text-red-400" />
                </div>
