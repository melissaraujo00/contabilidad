                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr class="border-t border-gray-200 dark:border-gray-700 
                                    ...
                                    <td class="px-4 py-2 text-gray-700 dark:text-gray-200">{{ $product->id }}</td>

                                    <td class="px-4 py-2 text-gray-700 dark:text-gray-200">{{ $product->nombre }}</td>
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        ...
                                        {{-- ELIMINAR --}}
                                        <button 
                                            @click="openModal = true; deleteUrl = '{{ route('products.destroy', $product->id) }}';"
